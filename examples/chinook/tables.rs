...
pub struct CustomerDummy<'t> {
    ...
    pub company: Db<'t, Option<String>>,
    pub address: Db<'t, String>,
    pub city: Db<'t, String>,
    pub state: Db<'t, Option<String>>,
    pub country: Db<'t, String>,
    pub postal_code: Db<'t, Option<String>>,
    pub phone: Db<'t, Option<String>>,
    pub fax: Db<'t, Option<String>>,
...
pub struct EmployeeDummy<'t> {
    ...
    pub reports_to: Db<'t, Option<Employee>>,
...
pub struct TrackDummy<'a> {
    ...
    pub composer: Db<'a, Option<String>>,
