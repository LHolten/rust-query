...
pub fn random_delivery(db: &Database<Schema>, warehouse: i64) {
    delivery(db, generate_input(warehouse));
}

fn generate_input(warehouse: i64) -> DeliveryInput {
    DeliveryInput {
        warehouse,
...
fn delivery(db: &Database<Schema>, input: DeliveryInput) {
