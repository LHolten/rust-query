...
pub mod migration {
    ...
    pub use crate::migrate::{Config, EasyMigratable, Migratable, Migrate, MigrateRow, Migrator};
...
pub mod private {
    ...
    pub use crate::migrate::{
        CacheAndRead, EasyMigratable, Migration, Schema, SchemaBuilder, TableTypBuilder,
    };
