...
impl<T: Table> MyTyp for T {
    ...
    const TYP: schema::ColumnType = schema::ColumnType::Integer;
...
impl MyTyp for f64 {
    type Prev = Self;
    const TYP: schema::ColumnType = schema::ColumnType::Float;
    type Out = Self;
    type Lazy<'t> = Self;
    type Ext<'t> = ();
    type Sql = f64;
...
impl MyTyp for String {
    type Prev = Self;
    const TYP: schema::ColumnType = schema::ColumnType::String;
    type Out = Self;
    type Lazy<'t> = Self;
    type Ext<'t> = ();
    type Sql = String;
...
impl MyTyp for Vec<u8> {
    type Prev = Self;
    const TYP: schema::ColumnType = schema::ColumnType::Blob;
    type Out = Self;
    type Lazy<'t> = Self;
    type Ext<'t> = ();
    type Sql = Vec<u8>;
...
impl<T: MyTyp> MyTyp for Option<T> {
    ...
    const TYP: schema::ColumnType = T::TYP;
